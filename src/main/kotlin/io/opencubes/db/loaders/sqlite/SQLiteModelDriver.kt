...
class SQLiteModelDriver(val filepath: String) : GenericSQLModelDriver() {
  ...
  override fun getSQLTypeFromClass(type: Class<*>, preferences: ValueWrapperPreferences<*>?): Pair<String, List<String>> {
    return when {
      ...
      Long::class.java.isAssignableFrom(type) -> "INTEGER" to emptyList()
      Short::class.java.isAssignableFrom(type) -> "INTEGER" to emptyList()
      Byte::class.java.isAssignableFrom(type) -> "INTEGER" to emptyList()
      Float::class.java.isAssignableFrom(type) -> "REAL" to emptyList()
      Double::class.java.isAssignableFrom(type) -> "REAL" to emptyList()
