...
//  }
  ...
  override fun getSQLTypeFromClass(type: Class<*>, preferences: ValueWrapperPreferences<*>?): Pair<String, List<String>> {
    return when {
      ...
      Long::class.java.isAssignableFrom(type) -> "BIGINT" to emptyList()
      Short::class.java.isAssignableFrom(type) -> "SMALLINT" to emptyList()
      Byte::class.java.isAssignableFrom(type) -> "TINYINT" to emptyList()
      Float::class.java.isAssignableFrom(type) -> "FLOAT" to emptyList()
      Double::class.java.isAssignableFrom(type) -> "DOUBLE" to emptyList()
